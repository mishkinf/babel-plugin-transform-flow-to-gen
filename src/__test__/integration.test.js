...
describe(`babel-plugin-transform-flow-to-gen`, () => {
  it(`works with simple types`, () => {
    ...
    const job1 = Job(other)
    expectType(job1.jobTitle, `string`);
    expectType(job1.other, `object`);
    expectType(job1.other.a, `string`);
    expectType(job1.other.b, `boolean`);

    const job2 = Job(types.string());
    expectType(job2.other, `string`);

    const worker = Worker(other);
    isPerson(worker);
    expectType(worker.jobTitle, `string`);
    expectType(worker.other.a, `string`);
  });

  // xit(`handles special generics appropriately`, () => {
  //   const {
  //     Critic,
  //   } = loadFixture(`types`);
  ...
  // xit(`works with indexers on objects`, () => {
  //   const {
  //     FoodForMovies,
  //   } = loadFixture(`types`);
  ...
  // xit(`works with simple function types`, () => {
  //   const {
  //     concat,
  //     setName,
  //     setNameThenCallback,
  ...
  // xit(`can add generators to nested functions`, () => {
  //   const {
  //     higherOrder,
  //     nestedFunction,
  //     otherNestedFunction,
